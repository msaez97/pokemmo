...
<body>
	...
	<main class="contenedor padding-all">
        ...
        <div class="grid-index">
            ...
            <div class="pokedexCarta">

            </div>
            <div class="objetosCarta">

            </div>
            <div class="regionesCarta">

            </div>
            <div class="localizacionesCarta">

            </div>
            <div class="npcsCarta">

            </div>
            <div class="mecanicasCarta">

            </div>
            <div class="eventosCarta">

            </div>
            <div class="extensionesCarta">
