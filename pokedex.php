...
<body>
	...
	<main class="contenedor">
		...
		<h2 class="padding-no-bottom h1-style">Herramienta esencial para todo entrenador pokemon</h2>
		...
		<h2 class="padding-no-bottom h1-style">Información sobre todos los pokemon de PokeMMO en Español</h2>
		...
		<h2 class="padding-no-bottom h1-style">¡Estrategias de pokemon en nuestra wiki de PokeMMO!</h2>
